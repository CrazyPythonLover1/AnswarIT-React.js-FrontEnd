        ...
        <div className="row w-100 m-0">
          <div className="col-lg-4 col-md-5">
            ...
            <div className="col-lg-8 col-md-7">
                ...
                <h5 className="p-1"> How Answar iT brings you the best in Business Process Assurance </h5>
                ...
                <p> <b> Process-Oriented Approach: </b> Better control means efficient management and thereby, improved results. Answar iT provides an end-to-end Business Process Test (BPT) QA approaches, which ensures to cover multiple systems, giving you better support structures that help sustain BPM excellence with ease.</p>

                <p> <b> Accelerated BPT:  </b> The success of a BPT QA approach greatly depends on the swiftness of its implementation. Answar iT ensures to optimize delivery by deploying product-specific QA accelerators that can kick-start the testing process of any project. The accelerators have been designed to work on predefined sector solutions and reference models containing adequate components and data for generic business processes. </p>

                <p> <b> Automated Testing:  </b>  Answar iT equips you with a more efficient test environment by combining the synergies of the latest test methodologies along with test automation tools, like HP's Quick Test Professional, for improved automated testing. </p>
                ...
                <h5 className="p-1"> BPA Solution Offered by Answar iT </h5>
                <ul>
