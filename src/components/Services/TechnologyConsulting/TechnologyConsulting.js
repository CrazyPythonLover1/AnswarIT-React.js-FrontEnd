...
const TechnologyConsulting = () => {
    return (
        <div>
            ...
            <p> <b> Experience and technology expertise:  </b> AnswarIT has experienced and dedicated team of technology professionals who together with customers, have conceptualized, developed and maintained mission-critical technology solutions. Our team has worked on diverse technology platforms.</p>

            <p> <b> Engagement models:  </b> AnswarIT is flexible in its engagement models with its customers. AnswarIT engages with customers based upon specific customer and project requirements. Engagement models include:</p>

            <ul>
                <li> “Augmentation of project staff” in a specific project for short term duration. </li>
                <li> “Project execution” with end to end project execution responsibility of a project with AnswarIT team. </li>
                <li> ”Managed services” with end to end business application responsibility with AnswarIT team. </li>
            </ul>

            <h5 className="p-1">Technology Services Offered by AnswarIT </h5>

            <p> AnswarIT believes that only a well-planned and innovative approach can help deliver exceptional results. Therefore, to help you expand the scope of your technology planning and management operations, we have condensed years of expertise into the following end-to-end Solution Modules: </p>
            ...
            <p> <b> Research and Development:  </b> In addition to custom projects, product implementation, AnswarIT experts can partner with you for new Software product or application development. If you have software solution idea in the form of product or application and want to kick start realization without building your own technology organization, AnswarIT can as your Research and Development center. </p>
