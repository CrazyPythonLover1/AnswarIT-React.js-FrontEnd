      ...
      <form id="contact" onSubmit={handleSubmit}>
        ...
        {id === 1 ? (
          <div>
            ...
            <fieldset>
              <h5>
                3) Which of the following command remove the paragraph
                formatting?
              </h5>
              <input
                onChange={handleChange}
            ...
            <fieldset>
              <h5>
                9) Which of the following is the smallest visual element on a
                video monitor?
              </h5>
              <input
                onChange={handleChange}
            ...
            <fieldset>
              <h5>
                10) Which of the following natural element is the primary
                element in computer chips?
              </h5>
              <input
                onChange={handleChange}
                type="radio"
          ...
          <h3>Blockchain related question will come soon!</h3>
        ) : (
